                            ...
                            <ul class="timeline-widget mb-0 position-relative mb-n5">
                                ...
                                <li class="timeline-item d-flex position-relative overflow-hidden">
                                    ...
                                    <div class="timeline-desc fs-3 text-dark mt-n1 fw-semibold">New sale recorded <a
                                            ...
                                            href="javascript:void(0)">#ML-3467</a>
                                    </div>
                                </li>
                                <li class="timeline-item d-flex position-relative overflow-hidden">
                    ...
                    <div class="card overflow-hidden rounded-2">
                        <div class="position-relative">
                            <a href="javascript:void(0)"><img alt="..."
                                                              ...
                                                              src="./assets/images/products/s4.jpg"></a>
                            <a class="bg-primary rounded-circle p-2 text-white d-inline-flex position-absolute bottom-0 end-0 mb-n3 me-3"
                               data-bs-placement="top"
                               data-bs-title="Add To Cart" data-bs-toggle="tooltip" href="javascript:void(0)"><i
                ...
                <div class="col-sm-6 col-xl-3">
                    <div class="card overflow-hidden rounded-2">
                        <div class="position-relative">
                            <a href="javascript:void(0)"><img alt="..."
                                                              class="card-img-top rounded-0"
                                                              src="./assets/images/products/s5.jpg"></a>
                            <a class="bg-primary rounded-circle p-2 text-white d-inline-flex position-absolute bottom-0 end-0 mb-n3 me-3"
                               data-bs-placement="top"
                               data-bs-title="Add To Cart" data-bs-toggle="tooltip" href="javascript:void(0)"><i
                                    class="ti ti-basket fs-4"></i></a></div>
                ...
                <div class="col-sm-6 col-xl-3">
                    <div class="card overflow-hidden rounded-2">
                        <div class="position-relative">
                            <a href="javascript:void(0)"><img alt="..."
                                                              class="card-img-top rounded-0"
                                                              src="./assets/images/products/s7.jpg"></a>
                            <a class="bg-primary rounded-circle p-2 text-white d-inline-flex position-absolute bottom-0 end-0 mb-n3 me-3"
                               data-bs-placement="top"
                               data-bs-title="Add To Cart" data-bs-toggle="tooltip" href="javascript:void(0)"><i
                                    class="ti ti-basket fs-4"></i></a></div>
                ...
                <div class="col-sm-6 col-xl-3">
                    <div class="card overflow-hidden rounded-2">
                        <div class="position-relative">
                            <a href="javascript:void(0)"><img alt="..."
                                                              class="card-img-top rounded-0"
                                                              src="./assets/images/products/s11.jpg"></a>
                            <a class="bg-primary rounded-circle p-2 text-white d-inline-flex position-absolute bottom-0 end-0 mb-n3 me-3"
                               data-bs-placement="top"
                               data-bs-title="Add To Cart" data-bs-toggle="tooltip" href="javascript:void(0)"><i
                                    class="ti ti-basket fs-4"></i></a></div>
